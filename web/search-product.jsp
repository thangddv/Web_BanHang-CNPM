                                            ...
                                            <div class="category">
                                                ...
                                                <div class="fr__product__inner">
                                                    ...
                                                    <ul class="fr__pro__prize">
                                                        <li class="old__prize">$${product.getPrice()-15}</li>
                                            ...
                                            <c:forEach var="product" items="${listProducts}">
                                                <div class="ht__list__product">
                                                    <div class="ht__list__thumb">
                                                        <a href="detail?product_id=${product.getProductId()}"><img src="${product.getImage()}"
                                                                                                                   alt="product images"></a>
                                                    </div>
                                                    <div class="htc__list__details">
                                                        <h2><a href="detail?product_id=${product.getProductId()}">${product.getName()}</a></h2>
                                                        <ul class="pro__prize">
                                                        ...
                                                        <div class="fr__list__btn">
                                                            <a class="fr__btn" href="addcart?product_id=${product.getProductId()}">Add To Cart</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </c:forEach>
                                        ...
                                        <div class="slider__range--output">
                                            <div class="price__output--wrap">
                                                <div class="price--output">
                                                    <span>Price :</span><input type="text" id="amount" name="amount">
                                                </div>
                                                <div class="price--filter">
                                                    <a href="product?filter=200&y=500">Filter</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="htc__recent__product__inner">
                                ...
                                <div class="htc__best__product">
                                    ...
                                    <div class="htc__best__product__details">
                                        <h2><a href="detail?product_id=${product.getProductId()}">Product Title Here</a></h2>
                                        <ul class="rating">
                                            <li><i class="icon-star icons"></i></li>
                                            <li><i class="icon-star icons"></i></li>
                                            <li><i class="icon-star icons"></i></li>
