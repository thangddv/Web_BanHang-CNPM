...
window.onload = function () {
    if (document.getElementById) {
        ...
        for (var i = 0; i < bubbles; i++) {
            ...
            div.bottom = "3px";
            div.right = "2px";
            div.borderLeft = "3px solid " + colours[3];
            div.borderRight = "3px solid " + colours[1];
            div = createDiv("auto", "auto");
            rats.appendChild(div);
            div = div.style;
            div.top = "9px";
            ...
            div.right = "9px";
            div.bottom = "9px"
            div.borderTop = "9px solid " + colours[0];
            div.borderBottom = "9px solid " + colours[2];
            div = createDiv("auto", "auto");
            rats.appendChild(div);
            div = div.style;
            div.left = "9px";
